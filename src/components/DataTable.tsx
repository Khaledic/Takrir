      ...
      <table className="w-full text-sm">
        ...
        <tbody>
          {data.map((row) => (
            <tr
              key={row.id}
              className="border-b border-github-border hover:bg-github-bg-tertiary transition-colors"
            >
              ...
              <td className="px-6 py-4 text-right">
                <button className="text-github-green hover:text-github-green-light transition-colors">
                  View
                </button>
              </td>
            </tr>
